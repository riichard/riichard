...
// Round all time notations
$(document).ready(function(){$(".time").text(function(a,b){return Math.round(parseFloat(b))})});
...
$(document).ready(function() {
    $('.search-field').simpleJekyllSearch({
        jsonFile      : site_url+'/bower_components/jekyll-rest-api/posts.json',
